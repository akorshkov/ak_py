...
def sh_print(*args, palette=None, sep=' ', end='\n', file=None, flush=False):
    ...
    SHText (that is objects which have 'sh_lines' or 'sh_text' methods)

    As the number of SHText lines generated by arg.sh_lines() may be large
    this method prints these lines as soon as it receives them.
    ...
    def _obj_to_print_items(obj):
        ...
        sh_lines_attr = getattr(arg, 'sh_lines', None)
