...
# _RequestAdapter object to request processing sequence and delegates
...
class _HttpConnBase:
    ...
    def __init__(self, adapters, conn_data):
        # Arguments:
        # - adapters: list of _RequestAdapter objects or a single such object
